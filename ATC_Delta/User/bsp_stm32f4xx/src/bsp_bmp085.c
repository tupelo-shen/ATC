...
static void BMP085_WaitConvert(void)
{
	if (g_tBMP085.OSS == 0)
	{
		bsp_DelayUS(6000);		/* 4.5ms  7.5ms  13.5ms   25.5ms */
	}
	else if (g_tBMP085.OSS == 1)
	{
		bsp_DelayUS(9000);		/* 4.5ms  7.5ms  13.5ms   25.5ms */
	}
	else if (g_tBMP085.OSS == 2)
	{
		bsp_DelayUS(15000);	/* 4.5ms  7.5ms  13.5ms   25.5ms */
	}
	else if (g_tBMP085.OSS == 3)
	{
		bsp_DelayUS(27000);	/* 4.5ms  7.5ms  13.5ms   25.5ms */
	}
}
